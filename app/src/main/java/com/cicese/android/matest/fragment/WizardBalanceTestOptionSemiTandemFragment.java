...
public class WizardBalanceTestOptionSemiTandemFragment extends Fragment {
    ...
    public static WizardBalanceTestOptionSemiTandemFragment newInstance(int position) {
        WizardBalanceTestOptionSemiTandemFragment f = new WizardBalanceTestOptionSemiTandemFragment();
        Bundle b = new Bundle();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        switch (position) {
            ...
            break;
            case 1: {
                ImageUtil.displayImage(image, "drawable://" + R.drawable.tutorial_17, null);
                text.setText(getResources().getString(R.string.balance_step_stay_semi_tandem));
            }
            break;
            case 2: {
