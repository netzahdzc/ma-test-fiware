...
import com.example.android.ollintest.view.AnimatedExpandableListView;
import com.example.android.ollintest.view.AnimatedExpandableListView.AnimatedExpandableListAdapter;
 ...
 */
public class FAQsListViewActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        item.title = getResources().getString(R.string.faq_q_activation_code);
        ChildItem child = new ChildItem();
        child.title = getResources().getString(R.string.faq_r_activation_code);
        item.items.add(child);
        items.add(item);

        GroupItem item3 = new GroupItem();
        item3.title = getResources().getString(R.string.faq_q_tug_test);
        ChildItem child3 = new ChildItem();
        child3.title = getResources().getString(R.string.faq_r_tug_test);
        item3.items.add(child3);
        items.add(item3);

        GroupItem item2 = new GroupItem();
        item2.title = getResources().getString(R.string.faq_q_contact_data);
        ChildItem child2 = new ChildItem();
        child2.title = getResources().getString(R.string.faq_r_contact_data);
    ...
    private class ExampleAdapter extends AnimatedExpandableListAdapter {
        ...
        public View getRealChildView(int groupPosition, int childPosition,
            ...
            if (convertView == null) {
                ...
                convertView = inflater.inflate(R.layout.list_item_faqs, parent,
                        false);
