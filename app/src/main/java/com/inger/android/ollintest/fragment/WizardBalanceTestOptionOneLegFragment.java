...
public class WizardBalanceTestOptionOneLegFragment extends Fragment {
    ...
    public static WizardBalanceTestOptionOneLegFragment newInstance(int position) {
        WizardBalanceTestOptionOneLegFragment f = new WizardBalanceTestOptionOneLegFragment();
        Bundle b = new Bundle();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        switch (position) {
            ...
            break;
            case 1: {
                ImageUtil.displayImage(image, "drawable://" + R.drawable.tutorial_18, null);
                text.setText(getResources().getString(R.string.balance_step_stay_one_leg));
            }
            break;
            case 2: {
